...
export const TRANSLATIONS = {
  en: {
    ...
    testCategoryUnitKeyboard: "Unit Tests - Keyboard",
    testCategoryIntegration: "Integration Tests",
    testCategoryUnitApp: "App Module Tests",
    testCategoryUnitUI: "UI Module Tests",
    testCategoryUnitTodoCategories: "Unit Tests - Todo Categories & Tags",
    testCategoryIntegrationCategories: "Integration Tests - Categories & Tags",
    testsPassed: "passed",
    testsFailed: "failed",
    testsTotal: "total",
    ...
    shortcutKeyToggleTheme: "Ctrl+G",
    shortcutToggleTheme: "Toggle theme (light/dark)",
    shortcutKeyToggleLanguage: "Ctrl+L",
  ...
  pt: {
    ...
    ariaThemeSettings: "Configurações de tema",
    ...
    testCategoryUnitKeyboard: "Testes Unitários - Keyboard",
    testCategoryIntegration: "Testes de Integração",
    testCategoryUnitApp: "Testes do Módulo App",
    testCategoryUnitUI: "Testes do Módulo UI",
    testCategoryUnitTodoCategories: "Testes Unitários - Categorias e Tags",
    testCategoryIntegrationCategories: "Testes de Integração - Categorias e Tags",
    ...
    shortcutKeyToggleLanguage: "Ctrl+L",
    shortcutToggleLanguage: "Alternar idioma",
    shortcutKeyFilterAll: "1",
